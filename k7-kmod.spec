...
Version:        10.3.0
Release:        1%{?dist}
Summary:        Luna K7 Host Driver (PCIe HSM)
License:        Safenet
...
install -p -m 644 -D pkg_files/etc/udev/rules.d/k7.rules %{buildroot}%{_udevrulesdir}/60-k7.rules
install -p -m 644 -D pkg_files/etc/modprobe.d/k7.conf %{buildroot}%{_prefix}/lib/modprobe.d/k7.conf
...
%{_prefix}/lib/modprobe.d/k7.conf
%{_udevrulesdir}/60-k7.rules
